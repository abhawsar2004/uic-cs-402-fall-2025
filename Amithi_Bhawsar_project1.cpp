...
int main() {
	...
	bubble_sort(nums);  // ascending by default
	...
	cout << endl;
	 ...
	 vector<int> nums2 = {7, 4, 6, 2, 8};
    	selection_sort(nums2);  // ascending
    	for (int n : nums2) {
        	cout << n << " ";
    	}
    	cout << endl;

	 vector<int> nums3 = {10, 1, 5, 7, 3};
    insertion_sort(nums3);  // ascending
    for (int n : nums3) {
        cout << n << " ";
    }
    cout << endl;

	 vector<int> nums4 = {12, 7, 14, 3, 9};
    quicksort(nums4);  // ascending
    for (int n : nums4) {
        cout << n << " ";
    }
    cout << endl;

	vector<int> nums5 = {20, 15, 30, 5, 10};
merge_sort(nums5);  // ascending
for (int n : nums5) {
    cout << n << " ";
}
cout << endl;

vector<int> nums6 = {50, 20, 60, 10, 40, 30};
bucket_merge_sort(nums6);  // ascending
for (int n : nums6) {
    cout << n << " ";
}
cout << endl;

vector<int> nums7 = {5, 1, 12, 7, 3, 8};
binary_radix_sort(nums7);  // ascending
for (int n : nums7) {
    cout << n << " ";
}
cout << endl;

vector<int> nums8 = {25, 17, 31, 13, 2, 40, 7, 19};
my_hybrid_sort(nums8);  // ascending
for (int n : nums8) {
    cout << n << " ";
}
cout << endl;
